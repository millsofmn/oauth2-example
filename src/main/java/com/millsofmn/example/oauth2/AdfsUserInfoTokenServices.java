...
/**
 * This is basically the same thing as UserInfoServices except that it
 * overrides the getMap function that decrypts the ADSF Oauth2 JWS Token
 * from the access token. The rest of this code is copied.
 *
 * Created by M108491 on 4/3/2017.
 */
